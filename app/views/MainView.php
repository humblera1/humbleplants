...
<div class="second-container">
        <div class="second-content-container">
            ...
            <div class="second-row-zero">
                <div class="text-container"><p>Затем, что так легко потеряться, когда решаешь завести представителя домашней флоры!</p></div>
            </div>
...
<div class="third-container">
        <div class="third-grid">
            <div class="third-title">
                <p>Фильтры в нашем каталоге помогут подобрать растение, отвечающее всем вашим критериям!</p>
            </div>
            <div class="third-wrapper-one">
                <div class="third-wrapper-grid-one">
                    <div class="third-content">
                        <div class="third-text">
                            <p class="third-text-title">Цимбидиум</p>
                            <div class="third-description"><p>Капризная орхидея, требующая <strong>частого полива</strong></p></div>
                        </div>                        
                    </div>
            ...
            <div class="third-wrapper-two">
                <div class="third-wrapper-grid-two">
                    <div class="third-content">
                        <div class="third-text">
                            <p class="third-text-title">Асплениум</p>
                            <div class="third-description"><p>Папоротник, спокойно переносящий <strong>полутень</strong></p></div>
                        </div>                        
                    </div>
            ...
            <div class="third-wrapper-three">
                <div class="third-wrapper-grid-three">
                    <div class="third-content">
                        <div class="third-text">
                            <p class="third-text-title">Цереус</p>
                            <div class="third-description"><p><strong>Засухостойкий</strong> кактус с необычным внешним видом</p></div>
                        </div>                        
                    </div>
            ...
            <div class="third-wrapper-four">
                <div class="third-wrapper-grid-four">
                    <div class="third-content">
                        <div class="third-text">
                            <p class="third-text-title">Хавортия</p>
                            <div class="third-description"><p>Крохотный и крайне <strong>неприхотливый</strong> суккулент</p></div>
                        </div>                        
                    </div>
            ...
            <div class="third-wrapper-big">
                <div class="third-wrapper-grid-five">
                    <div class="third-content-big">
                        <div class="third-text">
                            <p class="third-text-title">Ликуала</p>
                            <div class="third-description"><p>Домашняя пальма, которой необходимы <strong>ваше внимание</strong> и <strong>особый ухода</strong></p></div>
                        </div>                        
                    </div>
